...
const navItems: NavItem[] = [
  ...
  // Group 2 — CRM (jornada comercial)
  {
    ...
    subItems: [
      ...
      { title: "Pipeline (novo)", url: "/pipeline" },
  ...
  { title: "Campanhas", url: "/campaigns", group: 2, icon: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11l18-7v16l-18-7z"/><path d="M7 13v5a2 2 0 0 0 4 0v-3"/></svg> },
  { title: "Milhas", url: "/miles", group: 2, icon: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 3a13 13 0 0 1 0 18M12 3a13 13 0 0 0 0 18M3 12h18"/></svg> },
  ...
  // Group 3 — Financeiro
  {
    ...
    subItems: [
      ...
      { title: "Conciliação Bancária", url: "/finance/reconciliation" },
