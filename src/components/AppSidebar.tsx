...
const navItems: NavItem[] = [
  ...
  {
    title: "Contatos", url: "/contacts", group: 1,
    ...
    subItems: [
      { title: "Prospects", url: "/contacts?level=prospect" },
      { title: "Leads", url: "/contacts?level=lead" },
      { title: "Clientes", url: "/contacts?level=cliente" },
    ],
  },
  ...
  { title: "Agentes IA", url: "/ai-agents", group: 2, icon: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="8" width="16" height="12" rx="2" /><path d="M12 4v4" /><circle cx="12" cy="3" r="1" /><path d="M9 13h.01" /><path d="M15 13h.01" /><path d="M9 17h6" /><path d="M2 14v3" /><path d="M22 14v3" /></svg> },
  {
