// Countries with their states/regions for client registration
...
export const COUNTRIES_STATES: Record<string, string[]> = {
  ...
  "Vietnã": [],
  "Taiwan": [],
  "Emirados Árabes": ["Abu Dhabi", "Dubai", "Sharjah", "Ajman", "Umm Al Quwain", "Ras Al Khaimah", "Fujairah"],
  "Catar": [],
  "Israel": [],
  "Arábia Saudita": [],
  "África do Sul": [],
  ...
  "Etiópia": [],
  "Nigéria": [],
  "Austrália": ["NSW", "VIC", "QLD", "WA", "SA", "TAS", "ACT", "NT"],
  "Nova Zelândia": [],
};

export const COUNTRY_LIST = Object.keys(COUNTRIES_STATES).sort((a, b) => {
